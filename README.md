...
```javascript
varianceyc = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-varianceyc@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-varianceyc/tags). For example,

```javascript
varianceyc = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-varianceyc@v0.2.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var varianceyc = require( 'path/to/vendor/umd/stats-base-varianceyc/index.js' )
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-varianceyc.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-varianceyc

[test-image]: https://github.com/stdlib-js/stats-base-varianceyc/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/stats-base-varianceyc/actions/workflows/test.yml?query=branch:v0.2.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-varianceyc/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-varianceyc?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-varianceyc.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-varianceyc/main
...
[deno-readme]: https://github.com/stdlib-js/stats-base-varianceyc/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-varianceyc/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-varianceyc/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-varianceyc/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-varianceyc/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-varianceyc/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-varianceyc/main/LICENSE
